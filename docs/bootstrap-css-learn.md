...
> 学完本文档后 → [JavaScript 实战学习](./javascript-learn.md)（1～2 周，贴合 price.html）→ [全栈路线](./fullstack-frontend-roadmap.md)（Vue 阶段）
...
| 页面       | 地址                                                                                                   |
| -------- | ---------------------------------------------------------------------------------------------------- |
| 学习中心首页   | [http://localhost:9005/taian/learn](http://localhost:9005/taian/learn)                               |
| Day 1 练习 | [http://localhost:9005/learn/day1/practice.html](http://localhost:9005/learn/day1/practice.html)     |
| Day 2 练习 | [http://localhost:9005/learn/day2/responsive.html](http://localhost:9005/learn/day2/responsive.html) |
| 业务价格页    | [http://localhost:9005/taian/price](http://localhost:9005/taian/price)                               |
| 业务更新页    | [http://localhost:9005/taian/updatePrice](http://localhost:9005/taian/updatePrice)                   |
...
3. 访问 [http://localhost:9005/learn/day2/responsive.html](http://localhost:9005/learn/day2/responsive.html)
...
| 资源               | 链接                                                                                                                                 | 说明           |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| MDN CSS 入门       | [https://developer.mozilla.org/zh-CN/docs/Learn/CSS](https://developer.mozilla.org/zh-CN/docs/Learn/CSS)                           | Flexbox 章节优先 |
| Bootstrap 5.3 文档 | [https://getbootstrap.com/docs/5.3/getting-started/introduction/](https://getbootstrap.com/docs/5.3/getting-started/introduction/) | 官方文档         |
| Bootstrap 示例     | [https://getbootstrap.com/docs/5.3/examples/](https://getbootstrap.com/docs/5.3/examples/)                                         | 直接改官方示例      |
| Bootstrap Icons  | [https://icons.getbootstrap.com/](https://icons.getbootstrap.com/)                                                                 | 可选图标         |
